...
| [009 — Profile management over MCP](adr/009-profile-management-over-mcp.md) | Profile creation and partial updates; individual career-record CRUD with retry ids and version checks | Implemented and merged |

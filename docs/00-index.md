...
Status: Phase 0 implemented (career data entry); later phases are design. Updated 2026-09-13.
...
|---|---|---|
| [01 — Product and phases](01-product-and-phases.md) | What can users accomplish, and when? | Phase 0 implemented; later phases proposed |
| [02 — Domain model](02-domain-model.md) | What do the product's concepts mean? | Proposed vocabulary and rules |
| [03 — System and modules](03-system-and-modules.md) | Where does code run, and who owns behavior? | Profile module implemented; packaging proposed |
...
| [07 — Quickstart](07-quickstart-contract.md) | How do you run it, and what must the packaged install do? | Contributor path tested; user path a contract |
| [08 — Contributions and documentation](08-contributions-and-documentation.md) | How do changes stay understandable and documented? | CI and conventions in place |

...
Edit achievements in place. Do not create AchievementRevision records or a history UI. Phase 1b compromise, implemented: capture the selected facts and job description once per generation run and retain saved document revisions, especially submitted versions.

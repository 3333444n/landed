/*
 * The MCP handler for one request: a fresh server with tools bound to the authenticated request
 * context, the dependencies and the request's origin. No Next imports, so the integration test
